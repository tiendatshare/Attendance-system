...
SAMPLE_IMAGE_PATH = "Silent_Face_Anti_Spoofing\images\sample"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image_name",
        type=str,
        default="Silent_Face_Anti_Spoofing\images\sample\image_F1.jpg",
        help="image used to test")
    args = parser.parse_args()
    test(args.image_name, args.model_dir, args.device_id)# -*- coding: utf-8 -*-
